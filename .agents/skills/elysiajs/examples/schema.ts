...
const app = new Elysia()
  .model({
    name: t.Object({ name: t.String() }),
    b: t.Object({ response: t.Number() }),
    authorization: t.Object({ authorization: t.String() }),
  })
  ...
  .get('/query/:id', ({ query: { name }, params }) => name, {
    ...
    response: { 200: t.String(), 300: t.Object({ error: t.String() }) },
  })
  .guard({ headers: 'authorization' }, app =>
    app
      .derive(({ headers }) => ({ userId: headers.authorization }))
      .get('/', ({ userId }) => 'A')
